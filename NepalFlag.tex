...
\begin{center}
    ...
    \begin{tikzpicture}
        \definecolor{nepalRed}{RGB}{221, 12, 57}
        \definecolor{nepalBlue}{RGB}{0, 53, 148}
        \definecolor{nepalWhite}{RGB}{255, 255, 255}
        ...
        %Colouring
        \tkzFillPolygon[color=nepalBlue](ec,ed,da,ab,cb)
        \tkzFillPolygon[color=nepalRed](A,C,G,E,B)
        \tkzDrawArc[color=nepalWhite,fill=nepalWhite](M,P)(Q)
        \tkzDrawArc[color=nepalWhite,fill=nepalRed](L,P)(Q)
        \tkzFillPolygon[color=nepalWhite](A0,B1,A1,B2,A2,B3,A3,B4,A4,B5,A5,B6,A6,B7,A7,B8,A8,B9,B0)
        \tkzDrawSegment[color=nepalWhite](B0,B9)
        \tkzDrawArc[color=nepalWhite,fill=nepalWhite](L,B0)(B9)
        \tkzFillPolygon[color=nepalWhite](B'0,A'1,B'1,A'2,B'2,A'3,B'3,A'4,B'4,A'5,B'5,A'6,B'6,A'7,B'7,A'8,B'8,A'9,B'9,A'10,B'10,A'11,B'11,A'0)
